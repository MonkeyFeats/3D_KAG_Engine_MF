...
shared class BoundingFrustum : BoundingShape
{
    ...
    ContainmentType Contains(OBB box)
    {
    ...
    void Contains(OBB box, ContainmentType &out result)
    {
    ...
    {
        Vec3f otherSpherePos = sphere.parent.transform.getPosition();
        double dist = bottom.Normal.opMul(otherSpherePos);
        ...
        dist = top.Normal.opMul(otherSpherePos);
		dist += top.D;
		if (dist > sphere.Radius)
		{
			result = ContainmentType::None;
        ...
        dist = near.Normal.opMul(otherSpherePos);
		dist += near.D;
		if (dist > sphere.Radius)
		{
			result = ContainmentType::None;
        ...
        dist = far.Normal.opMul(otherSpherePos);
		dist += far.D;
		if (dist > sphere.Radius)
		{
			result = ContainmentType::None;
        ...
        dist = left.Normal.opMul(otherSpherePos);
		dist += left.D;
		if (dist > sphere.Radius)
		{
			result = ContainmentType::None;
        ...
        dist = right.Normal.opMul(otherSpherePos);
		dist += right.D;
		if (dist > sphere.Radius)
		{
			result = ContainmentType::None;
    ...
    void Intersects(OBB box, bool &out result)
    {
    ...
    private void CreatePlanes()
    {
        ...
        this.left = Plane(-this.matrix[3] - this.matrix[0], -this.matrix[7] - this.matrix[4],
                              -this.matrix[11] - this.matrix[8], -this.matrix[15] - this.matrix[12]);

        this.right = Plane(this.matrix[0] - this.matrix[3], this.matrix[4] - this.matrix[7],
                               this.matrix[8] - this.matrix[11], this.matrix[12] - this.matrix[15]);

        this.top = Plane(this.matrix[1] - this.matrix[3], this.matrix[5] - this.matrix[7],
                             this.matrix[9] - this.matrix[11], this.matrix[13] - this.matrix[15]);

        this.bottom = Plane(-this.matrix[3] - this.matrix[1], -this.matrix[7] - this.matrix[5],
                                -this.matrix[11] - this.matrix[9], -this.matrix[15] - this.matrix[13]);

        this.near = Plane(-this.matrix[2], -this.matrix[6], -this.matrix[10], -this.matrix[14]);


        this.far = Plane(this.matrix[2] - this.matrix[3], this.matrix[6] - this.matrix[7],
                             this.matrix[10] - this.matrix[11], this.matrix[14] - this.matrix[15]);
