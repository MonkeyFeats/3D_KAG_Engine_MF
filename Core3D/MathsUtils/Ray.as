...
shared class Ray
{
    ...
    bool Intersects(OBB box)
    {
        //first test if start in box
           if (Position.x >= box.Min.x
            ...
            return true;// here we consider cube is full and origin is in cube so intersect at origin
    ...
    //void Intersects(OBB box, double &out result)
    //{
    ...
    bool Intersects(BoundingSphere sphere, double &out outdistance)
    {
        ...
        Vec3f difference = sphere.parent.transform.getPosition() - this.Position;//this.parent.transform.getPosition() 
